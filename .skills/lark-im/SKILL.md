...
### messages
  ...
  - `delete` — 撤回消息。Identity: `user`; the caller can recall their own messages, and a group owner/admin can recall others' group messages.
  - `forward` — 转发消息。Identity: `user`.
